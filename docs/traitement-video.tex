...
{\centering \subfloat[-3\label{fig:unnamed-chunk-9-1}]{\includegraphics[width=0.14\linewidth]{medias/traiter/fx_obs/cc-gamma/01_-3} }\subfloat[-2\label{fig:unnamed-chunk-9-2}]{\includegraphics[width=0.14\linewidth]{medias/traiter/fx_obs/cc-gamma/02_-2} }\subfloat[-1\label{fig:unnamed-chunk-9-3}]{\includegraphics[width=0.14\linewidth]{medias/traiter/fx_obs/cc-gamma/03_-1} }\subfloat[0\label{fig:unnamed-chunk-9-4}]{\includegraphics[width=0.14\linewidth]{medias/traiter/fx_obs/cc-gamma/04_0} }\subfloat[1\label{fig:unnamed-chunk-9-5}]{\includegraphics[width=0.14\linewidth]{medias/traiter/fx_obs/cc-gamma/05_1} }\subfloat[2\label{fig:unnamed-chunk-9-6}]{\includegraphics[width=0.14\linewidth]{medias/traiter/fx_obs/cc-gamma/06_2} }\subfloat[3\label{fig:unnamed-chunk-9-7}]{\includegraphics[width=0.14\linewidth]{medias/traiter/fx_obs/cc-gamma/07_3} }

}

\caption{Plage d'influence du paramètre **gamma** sur grille de calibration couleur}\label{fig:unnamed-chunk-9}
\end{figure}
