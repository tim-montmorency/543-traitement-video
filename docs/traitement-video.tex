...
\hypertarget{protocole-de-transport}{%
\subsubsection{Protocole de transport}\label{protocole-de-transport}}

\url{https://en.wikipedia.org/wiki/Video}

\hypertarget{analogues}{%
\paragraph{Analogues}\label{analogues}}

\begin{longtable}[]{@{}lllll@{}}
\caption{Protocoles de transport pour signaux vidéos analogues (Amérique du Nord)}\tabularnewline
\toprule
...
\midrule
\endhead
\includegraphics{medias/lexique/signaux/analogue/composite.jpg} & \includegraphics{medias/lexique/signaux/analogue/svideo.jpg} & \includegraphics{medias/lexique/signaux/analogue/component.jpg} & \includegraphics{medias/lexique/signaux/analogue/vga.jpg} & \includegraphics{medias/lexique/signaux/analogue/3_5mm.jpg} \\
\bottomrule
\end{longtable}
...
\item
  ...
  \tightlist
  \item
    \textbf{S-Vidéo} peut être converti passivement vers \textbf{Composite} considérant une perte de qualité. (S-Vidéo \textgreater{} Composite)
  \item
...
\paragraph{Numériques}\label{numuxe9riques}}

\begin{longtable}[]{@{}llll@{}}
\caption{Protocoles de transport pour signaux vidéos numériques}\tabularnewline
\toprule
...
\midrule
\endhead
\includegraphics{medias/lexique/signaux/numerique/dvi.jpg} & \includegraphics{medias/lexique/signaux/numerique/hdmi.jpg} & \includegraphics{medias/lexique/signaux/numerique/displayport.jpg} & \includegraphics{medias/lexique/signaux/numerique/sdi.jpg} \\
\bottomrule
\end{longtable}
...
\item
  ...
  \tightlist
  \item
    \textbf{Display Port } peut passer passivement vers HDMI ainsi que DVI. Le contraire n'est pas vrai. On ne peut pas passer de passivement de HDMI vers Display port.
  \item
...
\hypertarget{type-de-muxe9dias-compressuxe9s-destructivement}{%
\paragraph{Type de médias compressés destructivement}\label{type-de-muxe9dias-compressuxe9s-destructivement}}
