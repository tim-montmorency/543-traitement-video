...
\hypertarget{compresseur-sur-la-piste-audio-compand-sans-recompresser-la-viduxe9o}{%
\subsection{Compresseur sur la piste audio (compand) sans recompresser la vidéo}\label{compresseur-sur-la-piste-audio-compand-sans-recompresser-la-viduxe9o}}
...
\begin{Shaded}
\begin{Highlighting}[]
\ControlFlowTok{for}\NormalTok{ file }\KeywordTok{in} \StringTok{"}\VariableTok{$1}\StringTok{"}\NormalTok{.}\PreprocessorTok{*}
\ControlFlowTok{do}
 \ExtensionTok{ffmpeg} \AttributeTok{{-}i} \StringTok{"}\VariableTok{$file}\StringTok{"} \DataTypeTok{\textbackslash{}}
 \AttributeTok{{-}vcodec}\NormalTok{ copy  }\AttributeTok{{-}filter\_complex} \DataTypeTok{\textbackslash{}}
 \StringTok{"compand=attacks=0:points={-}80/{-}900|{-}45/{-}15|{-}27/{-}9|0/{-}7|20/{-}7:gain=5"} \DataTypeTok{\textbackslash{}}
\NormalTok{ comp\_}\StringTok{"}\VariableTok{$file}\StringTok{"}
\ControlFlowTok{done}
\end{Highlighting}
\end{Shaded}
