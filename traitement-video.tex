...
\subsection{2,39:1}\label{section-5}}
...
\hypertarget{signaux-viduxe9o-standardisuxe9s}{%
\section{Signaux vidéo standardisés}\label{signaux-viduxe9o-standardisuxe9s}}

résolution \textbar{} protocoles de transport et connecteurs associé
...
\hypertarget{sans-perte-avec-perte-losslesslossy}{%
\subsection{Sans perte / avec perte (lossless/lossy)}\label{sans-perte-avec-perte-losslesslossy}}
...
\item
  Généralement plus facile à opérer en mémoire graphique (GPU)
\end{itemize}
...
\item
  Entre les nodes d
\item
  Quand la tête de lecture n'est pas linéaire du début vers la fin
  ...
  \item
    Montage vidéo
  \item
    Lecture à l'envers ou en palindrome
  \end{itemize}
\end{itemize}
...
\hypertarget{caractuxe9ristiques-1}{%
\paragraph{Caractéristiques:}\label{caractuxe9ristiques-1}}
...
\item
  Volumineux
\item
  Privilégié quand la tête de lecture n'est pas linéaire du début vers la fin
...
\hypertarget{compressions-applicables}{%
\subsection{Compressions applicables}\label{compressions-applicables}}
